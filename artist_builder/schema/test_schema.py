...
class TestArtistProfileSchema(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.valid_profile = {
            ...
            "update_history": [
                {"update_date": date.today(), "updated_fields": ["initial_creation"]}
            ],
    ...
    def test_valid_profile_validation(self):
        ...
        self.assertEqual(
            len(errors), 0, "Valid profile should have no validation errors"
        )
    ...
    def test_invalid_profile_validation(self):
        ...
        self.assertGreater(
            len(errors), 0, "Invalid profile should have validation errors"
        )
    ...
    def test_settings_validation(self):
        ...
        invalid_settings["release_strategy"][
            "video_release_ratio"
        ] = 2.0  # Out of range
    ...
    def test_composer_profile_generation(self):
        ...
        profile = self.composer.compose_profile(
            self.example_prompt, session_id="test_session_123"
        )
        ...
        for field in required_fields:
            self.assertIn(
                field, profile, f"Generated profile missing required field: {field}"
            )
    ...
    def test_edge_cases(self):
        ...
        self.assertTrue(
            is_valid, f"Special character profile failed validation: {errors}"
        )
