...
class ArtistPromptDesigner:
    ...
    def generate_prompt(self, parameters: Dict[str, str]) -> str:
        ...
        lifestyle_template = (
            random.choice(self.lifestyle_templates) if lifestyle else ""
        )
        appearance_template = (
            random.choice(self.appearance_templates) if appearance else ""
        )
        ...
        formatted_lifestyle = (
            lifestyle_template.format(lifestyle=lifestyle) if lifestyle else ""
        )
        formatted_appearance = (
            appearance_template.format(appearance=appearance) if appearance else ""
        )
