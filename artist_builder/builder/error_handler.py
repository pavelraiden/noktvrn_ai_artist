...
class ErrorHandler:
    ...
    def __init__(self, log_dir: Optional[str] = None, error_log_file: Optional[str] = None):
        """
    ...
    def handle_error(self, error: Exception, context: Dict[str, Any] = None, raise_error: bool = True) -> Optional[str]:
        """
    ...
    def get_recent_errors(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            sorted_errors = sorted(errors, key=lambda x: x.get("timestamp", ""), reverse=True)
    ...
    def clear_error_log(self) -> bool:
        ...
        try:
            ...
            backup_path = f"{self.error_log_path}.{datetime.now().strftime('%Y%m%d_%H%M%S')}.bak"
            import shutil
...
class LoggingManager:
    ...
    def get_logger(self, module_name: str) -> logging.Logger:
        ...
        try:
            ...
            logger.info(f"Set up logger for module {module_name} with log file {log_file}")
        except Exception as e:
    ...
    def log_performance(self, module_name: str, operation: str, duration_ms: float) -> None:
        """
    ...
    def log_api_call(self, api_name: str, params: Dict[str, Any], success: bool, duration_ms: float) -> None:
        """
        Log an API call.
        ...
        api_logger.info(f"API Call: {api_name} - {status} - {duration_ms:.2f}ms - Params: {json.dumps(params)}")

    def log_profile_operation(self, operation: str, profile_id: str, details: str = "") -> None:
        """
        ...
        profile_logger.info(f"Profile Operation: {operation} - Profile ID: {profile_id} - {details}")
