...
class TestArtistPromptDesigner(unittest.TestCase):
    ...
    def test_generate_prompt_complete(self):
        ...
        self.assertTrue("Mysterious" in prompt or "Cold" in prompt, 
    ...
    def test_multiple_generations(self):
        ...
        self.assertGreater(len(unique_prompts), 1, "Multiple generations should produce at least some different prompts")
