...
class SessionManager:
    ...
    def __init__(
        ...
        logger.info(f"Initialized session manager with storage directory: {storage_dir}")
    ...
    def _start_cleanup_task(self) -> None:
        ...
        logger.info(f"Cleanup task would run every {self.cleanup_interval_seconds} seconds")
