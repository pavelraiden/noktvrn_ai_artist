...
class VideoPromptGenerator:
    ...
    def _load_visual_style_database(self) -> Dict[str, Dict[str, Any]]:
        ...
        visual_style_elements = {
            "vhs retro": {
                ...
                "color_palette": ["muted colors", "high contrast", "slight color bleeding", "occasional color distortion"],
                "visual_elements": ["tracking lines", "timestamp overlay", "4:3 aspect ratio", "slight wobble", "static noise"],
                "editing_style": ["jump cuts", "zoom transitions", "occasional glitches", "date/time stamps"],
                "lighting": ["high contrast", "slightly washed out", "lens flares", "night scenes with glow"],
                "suitable_genres": ["synthwave", "vaporwave", "lo-fi", "phonk", "retro trap"]
            },
            "cinematic noir": {
                "description": "Dark, moody, film-noir inspired aesthetic with dramatic shadows and contrast",
                "color_palette": ["high contrast", "desaturated", "black and white", "dark blues", "deep shadows"],
                "visual_elements": ["dramatic shadows", "silhouettes", "rain-soaked streets", "neon reflections", "smoke"],
                "editing_style": ["slow pans", "dramatic cuts", "lingering shots", "extreme close-ups"],
                "lighting": ["dramatic side lighting", "harsh shadows", "low key", "spotlight effects"],
                "suitable_genres": ["dark trap", "jazz-influenced", "moody electronic", "atmospheric"]
            },
            "urban grime": {
                "description": "Raw, gritty urban aesthetic with street culture elements and rough textures",
                "color_palette": ["desaturated", "high contrast", "occasional color pops", "urban tones"],
                "visual_elements": ["graffiti", "concrete textures", "chain-link fences", "urban decay", "street signs"],
                "editing_style": ["quick cuts", "handheld camera feel", "occasional shake", "raw transitions"],
                "lighting": ["harsh street lights", "night scenes", "flashy highlights", "shadows"],
            ...
            "neon cyberpunk": {
                ...
                "color_palette": ["neon pink", "electric blue", "bright purple", "deep blacks", "high contrast"],
                "visual_elements": ["neon signs", "reflective surfaces", "digital overlays", "cityscapes", "tech elements"],
                "editing_style": ["glitch transitions", "digital distortion", "quick cuts", "overlay effects"],
                "lighting": ["neon glow", "high contrast", "colored lighting", "lens flares"],
                "suitable_genres": ["synthwave", "cyberpunk electronic", "future bass", "techno", "electronic"]
            },
            "dreamy aesthetic": {
                "description": "Soft, ethereal visuals with dreamy lighting, pastel colors, and gentle movements",
                "color_palette": ["pastel tones", "soft whites", "gentle pinks", "baby blues", "light exposure"],
                "visual_elements": ["lens flares", "soft focus", "floating particles", "nature elements", "clouds"],
                "editing_style": ["slow motion", "gentle transitions", "overlays", "soft fades"],
                "lighting": ["soft diffused light", "golden hour", "lens flares", "overexposure"],
                "suitable_genres": ["ambient", "chill", "lo-fi", "dream pop", "soft electronic"]
            },
            "hyper pop": {
                "description": "Exaggerated, colorful, internet-culture inspired aesthetic with digital elements",
                "color_palette": ["saturated colors", "neon", "pastel", "high contrast", "color shifts"],
                "visual_elements": ["digital icons", "emojis", "3D renders", "internet culture references", "glitch art"],
                "editing_style": ["extremely fast cuts", "digital transitions", "chaotic rhythm", "distortion effects"],
                "lighting": ["bright", "colorful", "shifting", "digital", "high contrast"],
                "suitable_genres": ["hyper pop", "glitch pop", "experimental electronic", "digital hardcore"]
            },
            "anime inspired": {
                "description": "Japanese animation inspired aesthetic with bold colors, dynamic movement, and stylized elements",
                "color_palette": ["bold colors", "high contrast", "flat color areas", "stylized lighting"],
                "visual_elements": ["anime clips", "manga panels", "Japanese text", "stylized effects", "character focus"],
                "editing_style": ["dynamic cuts", "speed lines", "impact frames", "dramatic pauses"],
                "lighting": ["dramatic", "stylized", "high contrast", "colored shadows"],
                "suitable_genres": ["j-pop influenced", "anime soundtracks", "future bass", "electronic"]
            },
            "minimalist": {
                "description": "Clean, simple aesthetic with focus on negative space, simple compositions, and subtle movements",
                "color_palette": ["monochrome", "limited palette", "high contrast", "clean whites", "deep blacks"],
                "visual_elements": ["simple shapes", "negative space", "clean typography", "minimal textures"],
                "editing_style": ["simple cuts", "static shots", "minimal movement", "deliberate pacing"],
                "lighting": ["clean", "even", "dramatic shadows", "high key"],
                "suitable_genres": ["minimal electronic", "ambient", "experimental", "modern classical"]
            }
        }
        ...
        if custom_db_path and os.path.exists(custom_db_path):
            try:
                with open(custom_db_path, 'r') as f:
                    ...
                    logger.info(f"Loaded custom visual style database from {custom_db_path}")
    ...
    def _load_footage_type_database(self) -> Dict[str, Dict[str, Any]]:
        ...
        footage_type_elements = {
            "urban": {
                ...
                "examples": [
                    "city skylines", "urban streets", "neon-lit alleys", "subway stations", 
                    "rooftops", "traffic", "city lights at night", "urban architecture"
                ],
                "mood_associations": ["energetic", "moody", "atmospheric", "gritty", "modern"],
                "suitable_genres": ["hip hop", "trap", "electronic", "pop", "r&b"]
            },
            "nature": {
                "description": "Natural environments and landscapes",
                "examples": [
                    "forests", "mountains", "oceans", "rivers", "deserts", "clouds", 
                    "sunsets", "wildlife", "plants", "rain", "snow"
                ],
                "mood_associations": ["peaceful", "majestic", "melancholic", "inspiring", "reflective"],
                "suitable_genres": ["ambient", "folk", "chill", "lo-fi", "acoustic"]
            },
            "abstract": {
                "description": "Non-representational, artistic, and experimental visuals",
                "examples": [
                    "ink in water", "light patterns", "particle effects", "glitch art", 
                    "3D renders", "abstract animations", "kaleidoscope effects"
                ],
                "mood_associations": ["mysterious", "experimental", "psychedelic", "artistic", "emotional"],
                "suitable_genres": ["electronic", "experimental", "ambient", "psychedelic", "avant-garde"]
            },
            "lifestyle": {
                "description": "People engaged in various activities and lifestyles",
                "examples": [
                    "fashion", "parties", "workouts", "dancing", "skateboarding", 
                    "driving", "shopping", "dining", "traveling"
                ],
                "mood_associations": ["energetic", "aspirational", "social", "trendy", "relatable"],
                "suitable_genres": ["pop", "hip hop", "dance", "electronic", "r&b"]
            },
            "nostalgic": {
                "description": "Retro and vintage-inspired footage evoking nostalgia",
                "examples": [
                    "vintage film", "old TV shows", "retro video games", "childhood toys", 
                    "vintage cars", "old technology", "historical footage"
                ],
                "mood_associations": ["nostalgic", "warm", "bittersweet", "comforting", "reflective"],
                "suitable_genres": ["lo-fi", "synthwave", "vaporwave", "indie", "retro-inspired"]
            },
            "automotive": {
                "description": "Cars, motorcycles, and automotive culture",
                "examples": [
                    "drifting cars", "night drives", "car meets", "motorcycles", 
                    "racing", "car details", "highway driving", "automotive POV"
                ],
                "mood_associations": ["exciting", "fast-paced", "cool", "powerful", "freedom"],
                "suitable_genres": ["phonk", "trap", "electronic", "hip hop", "rock"]
            },
            "anime": {
                "description": "Japanese animation and anime-inspired content",
                "examples": [
                    "anime clips", "manga panels", "anime characters", "anime scenery", 
                    "anime effects", "stylized animations"
                ],
                "mood_associations": ["expressive", "emotional", "stylized", "energetic", "dramatic"],
                "suitable_genres": ["j-pop", "future bass", "electronic", "lo-fi", "anime soundtracks"]
            },
            "cyberpunk": {
                "description": "Futuristic, high-tech, dystopian urban environments",
                "examples": [
                    "neon cities", "futuristic technology", "holograms", "cybernetic elements", 
                    "digital interfaces", "dystopian urban scenes"
                ],
                "mood_associations": ["futuristic", "edgy", "dark", "technological", "atmospheric"],
                "suitable_genres": ["synthwave", "cyberpunk electronic", "techno", "industrial", "electronic"]
            }
        }
        ...
        if custom_db_path and os.path.exists(custom_db_path):
            try:
                with open(custom_db_path, 'r') as f:
                    ...
                    logger.info(f"Loaded custom footage type database from {custom_db_path}")
            except Exception as e:
    ...
    def _load_special_effects_database(self) -> Dict[str, Dict[str, Any]]:
        ...
        special_effects_elements = {
            "retro": {
                ...
                "examples": [
                    "VHS tracking lines", "film grain", "color aberration", "date/time stamps", 
                    "old TV static", "film burns", "light leaks", "VHS rewind effects"
                ],
            ...
            "glitch": {
                ...
                "examples": [
                    "digital glitches", "pixel sorting", "datamoshing", "RGB splits", 
                    "digital artifacts", "scan lines", "digital noise", "frame drops"
                ],
                "suitable_styles": ["cyberpunk", "hyper pop", "digital"],
                "suitable_genres": ["electronic", "glitch hop", "experimental", "digital hardcore"]
            },
            "cinematic": {
                "description": "Effects that create a film-like quality",
                "examples": [
                    "letterboxing", "film grain", "color grading", "lens flares", 
                    "anamorphic lens effects", "cinematic transitions", "depth of field"
                ],
            ...
            "motion": {
                ...
                "examples": [
                    "slow motion", "time lapse", "motion blur", "speed ramping", 
                    "freeze frames", "reverse playback", "stutter cuts"
                ],
            ...
            "overlay": {
                ...
                "examples": [
                    "text overlays", "lyrics display", "animated graphics", "emoji", 
                    "particle effects", "light leaks", "dust particles", "weather effects"
                ],
            ...
            "transition": {
                ...
                "examples": [
                    "glitch transitions", "whip pans", "zoom transitions", "light leaks", 
                    "digital distortion", "color shifts", "wipes", "dissolves"
                ],
            ...
            "color": {
                ...
                "examples": [
                    "color grading", "duotone", "color shifting", "selective color", 
                    "RGB splits", "color flashes", "hue rotation", "saturation pulses"
                ],
            ...
            "3D": {
                ...
                "examples": [
                    "3D animations", "3D text", "parallax effects", "3D particle systems", 
                    "3D scene transitions", "depth mapping", "3D glitches"
                ],
                "suitable_styles": ["hyper pop", "neon cyberpunk", "minimalist"],
                "suitable_genres": ["electronic", "future bass", "trap", "experimental"]
            }
        }
        ...
        if custom_db_path and os.path.exists(custom_db_path):
            try:
                with open(custom_db_path, 'r') as f:
                    ...
                    logger.info(f"Loaded custom special effects database from {custom_db_path}")
            except Exception as e:
    ...
    def _load_social_trends_database(self) -> Dict[str, Dict[str, Any]]:
        ...
        social_trends_elements = {
            "tiktok": {
                ...
                "trending_formats": [
                    "transition reveals", "text-based storytelling", "POV videos", 
                    "before/after reveals", "lip syncing", "dance challenges", 
                    "day in the life", "outfit transitions"
                ],
                "popular_hashtags": [
                    "#fyp", "#foryoupage", "#viral", "#trending", "#aesthetic", 
                    "#vibes", "#pov", "#transition"
                ],
                "engagement_techniques": [
                    "hook in first 3 seconds", "text overlay storytelling", 
                    "trending sound usage", "call to action", "loop-worthy content"
                ],
            ...
            "instagram_reels": {
                ...
                "trending_formats": [
                    "aesthetic montages", "tutorial snippets", "outfit showcases", 
                    "behind the scenes", "day in the life", "transition videos", 
                    "quote/text reveals", "product showcases"
                ],
                "popular_hashtags": [
                    "#reels", "#instareels", "#trending", "#viral", "#aesthetic", 
                    "#vibes", "#explore", "#music"
                ],
                "engagement_techniques": [
                    "visually appealing aesthetic", "trending audio usage", 
                    "question prompts", "high-quality visuals", "lifestyle content"
                ],
            ...
            "youtube_shorts": {
                ...
                "trending_formats": [
                    "quick tutorials", "facts/information", "reaction clips", 
                    "comedy sketches", "music highlights", "gaming clips", 
                    "behind the scenes", "quick reviews"
                ],
                "popular_hashtags": [
                    "#shorts", "#youtubeshorts", "#viral", "#trending", "#music", 
                    "#gaming", "#tutorial", "#reaction"
                ],
                "engagement_techniques": [
                    "clear value proposition", "question hooks", "curiosity gaps", 
                    "quick educational content", "entertainment focus"
                ],
                "optimal_length": "15-60 seconds"
            },
            "threads": {
                ...
                "trending_formats": [
                    "aesthetic loops", "minimalist content", "text-heavy overlays", 
                    "conversation starters", "quick takes", "visual loops", 
                    "behind the scenes", "casual content"
                ],
                "popular_hashtags": [
                    "#threads", "#trending", "#aesthetic", "#vibes", "#loop", 
                    "#dailycontent", "#creator", "#mood"
                ],
                "engagement_techniques": [
                    "conversation starters", "relatable content", "aesthetic focus", 
                    "casual authentic feel", "community engagement"
                ],
        ...
        if custom_db_path and os.path.exists(custom_db_path):
            try:
                with open(custom_db_path, 'r') as f:
                    ...
                    logger.info(f"Loaded custom social trends database from {custom_db_path}")
            except Exception as e:
    ...
    def _extract_footage_types(self, genre: str, mood: str) -> List[str]:
        ...
        for footage_name, footage_data in self.footage_type_elements.items():
            ...
            genre_match = any(g.lower() in genre_lower or genre_lower in g.lower() 
                             for g in footage_data["suitable_genres"])
            
            # Check if mood matches
            mood_match = any(m.lower() in mood_lower or mood_lower in m.lower() 
        ...
        if not suitable_footage:
            suitable_footage = [
                "urban streets", "city lights", "abstract visuals", 
                "stylized scenes", "atmospheric footage"
            ]
    ...
    def _extract_special_effects(self, visual_style: str) -> List[str]:
        ...
        for effect_name, effect_data in self.special_effects_elements.items():
            ...
            style_match = any(s.lower() in style_lower or style_lower in s.lower() 
        ...
        if not suitable_effects:
            suitable_effects = [
                "color grading", "subtle transitions", "text overlays", 
                "motion effects", "atmospheric elements"
            ]
    ...
    def _determine_scene_dynamics(self, music_tempo: str, genre: str) -> str:
        ...
        dynamic_genres = ["edm", "trap", "electronic", "dance", "pop", "hip hop", "phonk"]
        ...
        if "slow" in tempo_lower:
            ...
            if genre_is_dynamic:
                return "steady movement with rhythmic patterns, occasional dynamic moments"
    ...
    def generate_video_prompt(
        ...
        """
        logger.info(f"Generating video prompt for artist: {artist_profile.get('name', 'Unknown')}")
        ...
        if not hashtags:
            hashtags = random.sample(platform_trends["popular_hashtags"], 
...
"""
    ...
    def generate_transition_prompt(
        ...
        Returns:
            Dictionary containing the generated prompt and metadata
        """
        logger.info(f"Generating transition prompt for artist: {artist_profile.get('name', 'Unknown')}")
...
"""
    ...
    def generate_text_overlay_prompt(
        ...
        Returns:
            Dictionary containing the generated prompt and metadata
        """
        logger.info(f"Generating text overlay prompt for artist: {artist_profile.get('name', 'Unknown')}")
...
def generate_video_prompt(
    ...
    return generator.generate_video_prompt(artist_profile, track_info, platform, overrides)
...
if __name__ == "__main__":
    ...
    transition_result = generator.generate_transition_prompt(example_artist, example_track)
