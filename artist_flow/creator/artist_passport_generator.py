...
class ArtistPassportGenerator:
    ...
    def generate_artist_passport(self, artist_brief: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"Generated Artist Passport for {artist_profile['profile']['name']}")
        return passport
    ...
    def _generate_artist_profile(self, artist_brief: Dict[str, Any]) -> Dict[str, Any]:
        ...
        artist_profile = {
            "profile": {
                ...
                "target_audience": metadata.get("target_audience", artist_brief.get("target_audience", "")),
                "visual_identity": metadata.get("visual_identity", artist_brief.get("visual_identity", "")),
                "lyrics_language": metadata.get("lyrics_language", artist_brief.get("lyrics_language", "English")),
                "themes": metadata.get("themes", artist_brief.get("themes", "")),
                "lifestyle": metadata.get("lifestyle", artist_brief.get("lifestyle", ""))
            },
            "prompt": prompt,
            "metadata": metadata
        }
...
def create_artist_passport_generator(seed: Optional[int] = None) -> ArtistPassportGenerator:
    """
    Factory function to create an artist passport generator.
...
if __name__ == "__main__":
    ...
    print(f"Profile Image: {passport['visual_assets']['profile_cover']['mock_image']['image_url']}")
    print(f"Track Cover: {passport['visual_assets']['track_cover']['mock_image']['image_url']}")
