...
from ...ai_artist_system.noktvrn_ai_artist.llm_orchestrator.orchestrator import LLMOrchestrator
...
async def test_llm_call_retry_on_rate_limit(mock_async_openai_class, orchestrator):
    ...
    mock_client_instance.chat.completions.create.side_effect = [
        ...
        getattr(__import__("openai", fromlist=["RateLimitError"]), "RateLimitError", Exception)("Rate limit exceeded"),
...
async def test_llm_call_fail_after_retries(mock_async_openai_class, orchestrator):
    ...
    RateLimitError = getattr(__import__("openai", fromlist=["RateLimitError"]), "RateLimitError", Exception)
    mock_client_instance.chat.completions.create.side_effect = RateLimitError("Rate limit exceeded")
