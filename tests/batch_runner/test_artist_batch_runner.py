...
class TestArtistBatchRunner(unittest.TestCase):
    ...
    def test_run_batch_cycle_success_approved(self):
        ...
        self.mock_update_status.assert_any_call(unittest.mock.ANY, "approved", "User approved")
    ...
    def test_run_batch_cycle_rejected(self):
        ...
        self.mock_update_status.assert_any_call(unittest.mock.ANY, "rejected", "User rejected")
    ...
    def test_run_batch_cycle_timeout(self):
        ...
        self.mock_time_time.side_effect = [1000.0, 1000.0, 1002.0, 1004.0, 1006.0, 1008.0, 1010.0, 1012.0]
    ...
    def test_run_batch_cycle_telegram_send_fails(self):
        ...
        self.mock_update_status.assert_called_with(
             unittest.mock.ANY, "failed_approval_send", "Failed to send to Telegram"
        )
