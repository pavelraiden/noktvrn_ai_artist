...
class TestArtistBatchRunner(unittest.TestCase):
    ...
    def test_create_initial_run_status(self):
        ...
        with patch("builtins.open", mock_open()) as mock_file:
            ...
            mock_file.assert_called_once_with(
                os.path.join(self.test_run_status_dir, f"run_{run_id}.json"), "w"
            )
    ...
    def test_check_approval_status_approved(self, mock_exists):
        ...
        with patch("builtins.open", mock_open(read_data=mock_data)) as mock_file:
            ...
            mock_file.assert_called_once_with(
                os.path.join(self.test_run_status_dir, f"run_{run_id}.json"), "r"
            )
    ...
    def test_run_batch_cycle_timeout(self):
        ...
        self.mock_check_approval.side_effect = [
            None
        ] * 10  # More checks than needed for timeout
        ...
        time_calls = [1000.0] + [
            1000.0 + i * poll_interval
            for i in range(int(wait_time / poll_interval) + 2)
        ]
    ...
    def test_run_batch_cycle_track_generation_fails(self):
        ...
        with patch("artist_batch_runner.update_run_status") as mock_update_status:
            ...
            mock_update_status.assert_called_with(
                unittest.mock.ANY, "failed_generation", "Track generation failed"
            )
    ...
    def test_run_batch_cycle_video_selection_fails(self):
        ...
        with patch("artist_batch_runner.update_run_status") as mock_update_status:
            ...
            # Check if status updated to failure
            mock_update_status.assert_called_with(
                unittest.mock.ANY, "failed_generation", "Video selection failed"
            )
