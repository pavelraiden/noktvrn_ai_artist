...
async def send_preview_to_telegram(run_id: str, caption: str, release_id: str | None = None):
    ...
    masked_token = ("*" * (len(TELEGRAM_BOT_TOKEN) - 4) + TELEGRAM_BOT_TOKEN[-4:]) if TELEGRAM_BOT_TOKEN else "Not Set"
